...
<context>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、Noxcoinトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、Noxcoinが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはNoxcoinプロジェクトによって保守されnoxcoin.orgのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはnoxcoin-blockchain-mark-spent-outputsというツールを使い、Noxcoinのブロックチェーン(およびキーを再利用するNoxcoinクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
...
アップグレードするか別のデーモンに接続してください</translation>
    ...
    <message>
        ...
        <translation>支出可能な資金: %1 NOX. 全ての残高が利用可能になるまで~%2分ほどお待ちください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>NOXをコールド(オフライン)ウォレットから消費する</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>noxcoin.orgを訪問して詳細を確認してください</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このアドレスは%1NOXを受け取りましたが、取引はまだ承認されていません</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1055"/>
        <source>This address received %1 noxcoin, with %2 confirmation(s).</source>
        <translation>このアドレスは%1NOXを受け取り、その取引は%2回承認されました。</translation>
    </message>
    <message>
