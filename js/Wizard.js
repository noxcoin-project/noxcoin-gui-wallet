...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of noxcoin birth 2014-04-18 10:49:53 (1397818193)
    var noxcoinBirthTime = _nettype == "Mainnet" ? 1397818193 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    ...
    var secondsPerBlock;
    // before noxcoin's birth
    if (requestedTime < noxcoinBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < noxcoinBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > noxcoinBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - noxcoinBirthTime)/secondsPerBlockV1);
